...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
        ...
        // TODO With functional interfaces declared
 Predicate<User> ageLessThan10Predicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age < 10;
            }
        ...
        repository.select(ageLessThan10Predicate, ageComparator);
        ...
        // TODO With functional interfaces declared
         ...
         Predicate<User> activeUsersPredicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active;
            }
        ...
        repository.select(activeUsersPredicate, sortByNameComparator);
        ...
        // TODO With functional interfaces declared
         Predicate<User> activeAndAge8Plus = new Predicate<User>() {
            @Override
            public boolean test(User user) {
        ...
        repository.select(activeAndAge8Plus, nameSort);
